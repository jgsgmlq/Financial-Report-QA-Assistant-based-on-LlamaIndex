...
The project adopts a modular design, mainly consisting of the following directory structure:
...
The system runs on a Mac Studio (M3 Ultra) with the following environment and configuration:

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{image/prompts/env.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{image/prompts/config.png}
